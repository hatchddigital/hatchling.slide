 ...
 * @see http://hatchd.com.au
 *
 */(function(){var e="hl-slide",t="state-current",n="state-inactive",r="hide",i="hls-link",s="hls-item",o="hls-next",u="hls-prev",a=function(e,n,o){var u=this;this.$element=$(e);this.visible=n||!1;this.items=this.$element.find("."+s);this.links=this.$element.find("."+i);this.panel_width=this.$element.outerWidth();this.options=$.extend({loop:!1},o);var a=this.items.length*this.locs().width,f=this.visible*this.locs().width,l={},c={position:"absolute",top:0,left:0,display:"block",width:a+"px",background:"blue"};if(!(this.current=this.items.find(t)).length){this.current=this.items.first();this.current.addClass(t)}this.items.not("."+t).addClass(r);this.refresh_state();return this};a.prototype.locs=function(){var e=this;return{before:function(){return 0}(),after:function(){return 0},width:function(){var t=e.items.first().outerWidth();return t}()}};a.prototype.prev=function(e){var t=this.locs(),n=this.current.prev("."+s),r=!1;if(!n.length&&this.options.loop){r=!0;n=this.items.last()}if(!n.length)return!1;this.swap(n,r)};a.prototype.next=function(e){var t=this.locs(),n=this.current.next("."+s),r=!1;if(!n.length&&this.options.loop){r=!0;n=this.items.first()}if(!n.length)return!1;this.swap(n,r)};a.prototype.swap=function(e,n){var i=this,s=1;n=n?-1:1;if(i.current[0]===e[0])return!1;for(var o=i.items.length-1;o;o--){if(i.items[o]==i.current[0])break;if(i.items[o]==e[0]){s=-1;break}}s*=n;e.css({left:i.panel_width*-s});i.current.animate({left:i.panel_width*s},function(){$(i).css("left","")});e.animate({left:0},function(){$(i).css({left:""});i.current.removeClass(t).addClass(r);e.removeClass(r).addClass(t)});i.current=e;i.refresh_state()};a.prototype.refresh_state=function(){var e=this.$element.find("."+u),r=this.$element.find("."+o);this.current.next("."+s).length?r.removeClass(n):r.addClass(n);this.current.prev("."+s).length?e.removeClass(n):e.addClass(n);this.links.parent().removeClass(t);var i=this.$element.find('a[href="#'+this.current.attr("id")+'"]');i.parent().addClass(t)};$.fn.slide=function(t){t=t||{};this.each(function(){var n=$(this),r=!1;r||n.data(e,r=new a(this,t.visible||3,t));n.find("."+o).click(function(e){e.preventDefault();r.next()});n.find("."+u).click(function(e){e.preventDefault();r.prev()});r.links.each(function(){$(this).click(function(e){e.preventDefault();r.swap($($(this).attr("href")))})})});if(this.length===1)return $(this).data(e)}})(window.jQuery);